...
public class ParseACL implements Parcelable {
  ...
  public static void setPublicReadAccess() {
  ...
  // State
  private static final Map<String, Permissions> permissionsById = new HashMap<>();
  ...
  private static void setPermissionsIfNonEmpty(String userId, boolean readPermission, boolean writePermission) {
   ...
   */
  public static void setPublicReadAccess(boolean allowed) {
   ...
   */
  public static void setPublicWriteAccess() {
   ...
   * Set whether the public is allowed to write this object.
   */
  public static boolean getPublicWriteAccess() {
   ...
   */
  public static void setReadAccess(String userId, boolean allowed) {
    if (userId == null) {
   ...
   */
  public static boolean getReadAccess(String userId) {
    if (userId == null) {
   ...
   */
  public static void setWriteAccess(String userId, boolean allowed) {
    if (userId == null) {
   ...
   */
  public static boolean getWriteAccess(String userId) {
    if (userId == null) {
